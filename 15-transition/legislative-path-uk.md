...
- **Phase 1 (basis switch)** is designed revenue-neutral; the scoring risk is behavioural assumptions about gift re-timing, on which OBR costings of past IHT changes provide the methodology (to verify against OBR policy-costings database).
...
Inheritance tax is a **reserved matter** under the Scotland Act 1998 and the Welsh and Northern Ireland settlements (to verify the precise reservation heads) — the tax legislates UK-wide, which is essential given the Australian lesson that sub-national assignment is fatal ([`../05-history/abolitions.md`](../05-history/abolitions.md)). Three wrinkles:
...
- **Scots property and trust law** differs (no equitable/legal title split; different succession rules including legal rights of children), requiring Scots-specific drafting in the receipts definition (to verify with Scots-law input; see [`../07-implementation/hard-cases.md`](../07-implementation/hard-cases.md)).

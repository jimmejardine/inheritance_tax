...
**Executive summary.** Across the US and most advanced economies, the standard indicators of economic dynamism — business formation, young-firm employment share, job reallocation, worker mobility — have declined since the early 1980s, over precisely the period in which wealth concentrated and its ownership aged. The mechanism this chapter isolates: capital locked into incumbent families and ageing owners is allocated for *preservation*, not *creation*, so dynasticism is not merely unfair but a direct tax on the economy's capacity to renew itself.
...
**The dynamism facts.** The Decker–Haltiwanger body of work, built on the Census Bureau's Business Dynamics Statistics, is the empirical backbone. Its core findings — declining entry, declining young-firm employment share, declining reallocation, and (after 2000) declining high-growth young firms specifically — have survived a decade of scrutiny [1][2][3]. Akcigit & Ates provide the synthesis most useful here: they attribute the pattern to declining knowledge diffusion and strengthened incumbency advantages, i.e., a shift in the balance of power from challengers to incumbents [4].
...
1. *Allocation for preservation.* A first-generation founder's capital is, by construction, deployed in a new venture. A second- or third-generation holder's capital is, by strong empirical regularity, deployed in diversified, income-generating, low-volatility form: property, index funds, bonds, and the family operating business run defensively. Family-firm research (Bloom & Van Reenen's management surveys; [Pérez-González](https://www.aeaweb.org/articles?id=10.1257/aer.96.5.1559) and Bennedsen et al. on heir-CEO underperformance) consistently finds dynastic succession reduces firm performance and investment aggressiveness — heirs are, on average, worse and more conservative stewards than professional managers or founders [10][11].
2. *Blocked reallocation.* Dynamism requires that assets — buildings, firms, land, market positions — move from weaker to stronger hands. Inheritance is the single largest non-market allocation mechanism in the economy: it assigns control of capital by birth rather than by any test of use-value, and (via stepped-up basis in the US and death-uplift in the UK CGT regime) tax codes actively *reward* holding appreciated assets until death rather than selling to a better user. The lock-in is a designed feature of current law.
3. *Demand-side gerontocracy.* As the wealth-holding population ages ahead of the transfer wave documented in [great-wealth-transfer.md](great-wealth-transfer.md), the aggregate risk appetite of the capital stock falls mechanically, independent of any individual's choices. An economy whose marginal saver is a 70-year-old seeking yield is an economy that bids up existing assets (see [asset-price-feedback.md](asset-price-feedback.md)) rather than funding entry.
...
1. [Decker, R., Haltiwanger, J., Jarmin, R., Miranda, J. (2014). "The Role of Entrepreneurship in US Job Creation and Economic Dynamism." *JEP* 28(3)](https://www.aeaweb.org/articles?id=10.1257/jep.28.3.3)

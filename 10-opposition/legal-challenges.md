...
| US federal courts | Realization / Sixteenth Amendment adjacent arguments | Weak but newly energised | *Moore v. United States* (2024) left realization questions open in dicta; expect creative extensions (to verify applicability — a transfer tax is not an income tax) [3] |
...
- **German BVerfG 1995 and 2006 rulings** struck the *valuation* regime (unequal treatment of asset classes), not the tax; the famous 1995 suggestion of a 50% overall cap on taxation (*Halbteilungsgrundsatz*) arose in the wealth-tax context and was expressly disavowed by the court in 2006 (to verify citations: BVerfGE 93, 121; BVerfGE 115, 97) [7].

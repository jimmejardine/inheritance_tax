# Legal Challenges: The Constitutional and Convention Attacks
...
|---|---|---|---|
| US federal courts | Direct-tax apportionment (Art. I) | Weak | *Knowlton v. Moore* (1900) upheld the federal death duty as an indirect excise on the transfer, not a direct tax on property; *New York Trust Co. v. Eisner* (1921) confirmed for the estate tax [1] |
| US federal courts | Fifth Amendment takings / due process | Weak-to-moderate | Taxation is generally not a taking; but dicta reserve the case of a tax "so arbitrary as to constrain to the conclusion that it was not the exertion of taxation" (*A. Magnano Co. v. Hamilton*, 1934) — a 100% rate invites the test [2] |
| US federal courts | Realization / Sixteenth Amendment adjacent arguments | Weak but newly energised | *Moore v. United States* (2024) upheld the mandatory repatriation tax on narrow grounds and expressly declined to resolve whether realization is constitutionally required; expect creative extensions (a transfer tax is not an income tax) [3] |
| ECtHR / UK courts (HRA) | A1P1 (protection of property): proportionality, "individual and excessive burden" | Moderate | Wide margin of appreciation in taxation (*Gasus Dosier v Netherlands*, 1995; *National & Provincial Building Society v UK*, 1997); but *N.K.M. v Hungary* (2013) struck a 98% tax on severance pay as disproportionate [4][5] |
| ECtHR / UK courts | A1P1 + legal certainty: retrospectivity | Moderate on transition design | Retrospective tax is not per se prohibited, but retroactive reach-back to completed transactions weighed heavily in *N.K.M.* [5] |
| EU courts (for member states) | Free movement of capital, Art. 63 TFEU — applies to inheritances | Real but narrow | *Jäger* (C-256/06), *Welte* (C-181/12) and related cases: inheritances are capital movements; discrimination between resident and non-resident situations is the vice, not the rate [6] |
| German BVerfG (comparator) | Equality (Art. 3 GG), protection of marriage/family and inheritance (Art. 14 GG) | Instructive both ways | See below |
...
**Where high taxation fell.** The instructive adverse cases share features this proposal must avoid:

- *N.K.M. v Hungary* (2013): a 98% rate applied to severance pay, with retroactive effect, no transition, hitting a person of modest means on income already earned. The Court stressed the *combination* — confiscatory rate, retrospectivity, and individualised excessive burden — not the rate alone [5].
- **German BVerfG 1995 and 2006 rulings** struck the *valuation* regimes (unequal treatment of asset classes: BVerfGE 93, 165 (1995) and BVerfGE 117, 1 (2006, 1 BvL 10/02) for the inheritance tax), not the tax; the famous 1995 suggestion of a 50% overall cap on taxation (*Halbteilungsgrundsatz*) arose in the parallel wealth-tax decision (BVerfGE 93, 121) and was expressly disavowed by the court in 2006 (BVerfGE 115, 97) [8].
- **German BVerfG December 2014**: the business-relief provisions of the inheritance tax were unconstitutional — because they were *too generous*, privileging business heirs without sufficient justification [7]. This is the single most useful precedent in the file: the leading modern constitutional strike against an inheritance-tax statute was against its carve-outs, not its burden. It cuts directly against the carve-out-stuffing strategy in [sabotage-after-passage.md](sabotage-after-passage.md).
...
- Translated key passages of the German BVerfG line (citations now confirmed [7][8]) for the annex.
...
2. **No forced-sale exposure.** Statutory guarantee that liability on illiquid assets is always dischargeable by deferral (30-year, gilts + 1%) or state equity stake — [../02-proposal/carveouts.md](../02-proposal/carveouts.md). This removes the "individual and excessive burden" limb that decided *N.K.M.* [5].
3. **Prospective-only application, announced with a clean line.** Tax only receipts after the commencement date; anti-forestalling rules for the announcement-to-commencement window drafted as prospective conduct rules, not retroactive charges — [../15-transition/sequencing.md](../15-transition/sequencing.md) and [../15-transition/announcement-effects.md](../15-transition/announcement-effects.md).
4. **Valuation safety valves.** Statutory right to tender the asset itself (or a fractional interest) in satisfaction of the liability at the disputed valuation — collapsing any claim that the effective rate exceeds 100% of real value. Mechanics in [../07-implementation/valuation.md](../07-implementation/valuation.md).
...
3. [*Moore v. United States*, 602 U.S. 572 (2024) — slip opinion](https://www.supremecourt.gov/opinions/23pdf/22-800_jg6o.pdf)
...
8. [BVerfGE 93, 121 (22 June 1995, wealth tax / *Halbteilungsgrundsatz*)](https://www.servat.unibe.ch/dfr/bv093121.html); [BVerfGE 93, 165 (22 June 1995, inheritance-tax valuation)](https://www.servat.unibe.ch/dfr/bv093165.html); [BVerfG, 18 January 2006 — 2 BvR 2194/99 (BVerfGE 115, 97, disavowing the *Halbteilungsgrundsatz*)](https://www.bundesverfassungsgericht.de/SharedDocs/Entscheidungen/DE/2006/01/rs20060118_2bvr219499.html); [BVerfG, 7 November 2006 — 1 BvL 10/02 (BVerfGE 117, 1, inheritance-tax valuation, English abstract)](https://www.bundesverfassungsgericht.de/SharedDocs/Entscheidungen/EN/2006/11/ls20061107_1bvl001002en.html)

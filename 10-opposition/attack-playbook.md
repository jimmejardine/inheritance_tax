# The Attack Playbook: Anatomy of the US "Death Tax" Repeal Campaign

**Executive summary.** The most successful anti-inheritance-tax campaign in history — the US "death tax" repeal movement of the 1990s culminating in the 2001 phase-out — was not a spontaneous taxpayer revolt but a fifteen-year engineered campaign combining linguistic reframing, hard-case theatre, a coalition of sympathetic fronts, and incremental legislation. Its playbook is fully documented, entirely reusable, and will be rerun against this proposal; the countermeasures must therefore be built into the design before launch, not improvised afterwards.
...
| NFIB and American Farm Bureau | Sympathetic fronts | Small business and farm faces fronted a campaign whose fiscal benefit flowed overwhelmingly to the largest estates |
| Frank Blethen / Seattle Times | Media owner-advocate | Family owner of the Seattle Times personally organised newspaper-industry lobbying for repeal, blurring proprietor interest and editorial voice — see [elite-media-capture.md](elite-media-capture.md) [1] |

## The five reusable moves
...
| 5 | **Salami legislation** | Rather than one repeal vote, EGTRRA 2001 phased rates down and exemptions up over a decade, with full repeal scheduled for 2010 — normalising erosion step by step | The mirror-image threat post-passage: carve-out stuffing and threshold erosion — see [sabotage-after-passage.md](sabotage-after-passage.md) |

## What made it work: the deeper mechanics

- **Asymmetric intensity.** The wealthy few had concentrated, existential stakes; the diffuse majority had weak, abstract stakes. Classic Olsonian collective-action asymmetry — and the same asymmetry documented in [../01-problem/political-capture.md](../01-problem/political-capture.md).
- **No countervailing constituency.** The estate tax funded general revenue. Nobody's named benefit disappeared with repeal, so nobody organised to defend it. This is the strongest single argument for hypothecating this proposal to the universal endowment — see [../02-proposal/endowment.md](../02-proposal/endowment.md).
...
|---|---|---|
| Seeding | early 1990s | "Death tax" language tested and propagated; Policy and Taxation Group organises family funders; academic and think-tank groundwork commissioned |
| Coalition-building | mid 1990s | NFIB, Farm Bureau, 60 Plus and newspaper-owner groups aligned; repeal bills introduced each Congress; pledge infrastructure (ATR) binds candidates |
| Normalisation | 1997–2000 | Exemption increases enacted; repeal votes pass the House with growing bipartisan margins; presidential candidates adopt repeal |
| Harvest | 2001 | EGTRRA phases rates down, exemption up, schedules 2010 repeal with a 2011 sunset |
| Aftermath | 2002–2012 | Permanent repeal repeatedly fails; 2010 gap year; 2012 settlement at a high exemption — repeal's substance without repeal's name |
...
Early-warning indicators, in the rough order they appeared in the US campaign:

- A tested pejorative name appears simultaneously across unrelated outlets and spokespeople.
- Polling is published showing opposition to the tax using estate-framed question wording only.
- A "grassroots" coalition launches with professional-grade branding and no published funder list.
- Identical hard-case anecdotes circulate before any specific family can be named or verified.
- Amendments are proposed that are individually modest and cumulatively fatal.

Each signal maps to a standing response owned by the rapid-response unit described in [media-narratives.md](media-narratives.md).
...
Argument-level rebuttals live in [../09-objections/](../09-objections/); these are the campaign-level counter-strategies.

1. **Prebunk, don't debunk.** Inoculation theory says exposure to a weakened form of an attack plus its refutation confers resistance. Publish the opponents' playbook — this file's five moves — as part of the launch communications, so audiences recognise "death tax" branding and farm vignettes as rehearsed tactics when they arrive. See [../14-communications/inoculation.md](../14-communications/inoculation.md).
2. **Own the name first.** Never let the policy enter public debate unnamed. Lead with the endowment ("universal inheritance," "the £50k promise") so the fight is over their counter-brand, not ours. See [../14-communications/naming-and-language.md](../14-communications/naming-and-language.md).
3. **Recipient framing as structure, not spin.** The proposal genuinely taxes the *receipt* of unearned windfalls, not death or the deceased. Every spokesperson drills the correction: "No one is taxed for dying. Someone is taxed for receiving more than £500,000 they did not earn." See [../06-palatability/framing.md](../06-palatability/framing.md).
4. **Carve-outs before launch.** The farm and family-business hard cases must be designed out — deferral, instalments, hardship clauses — *before* the first announcement, so the vignette machine finds no true cases and must fabricate, which is attackable. See [../02-proposal/carveouts.md](../02-proposal/carveouts.md) and [media-narratives.md](media-narratives.md).

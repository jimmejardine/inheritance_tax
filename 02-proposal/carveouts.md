...
- Full exemption for spouses and civil partners; full exemption for registered charities, with a statutory anti-cycling rule [1].
...
**What it covers.** Transfers of any size between legally married spouses or registered civil partners, lifetime or on death.
**Mechanism.** Full exemption; the threshold is not consumed. Transfers between partners are not "receipts" for lifetime-cumulative purposes.
**Anti-abuse.** Marriage is a legal status check; sham-marriage rules mirror immigration law.
**Precedent.** The UK spousal exemption (IHTA 1984 s.18) and US unlimited marital deduction (IRC §2056) are long-standing and politically untouchable [1]. Removing it was never seriously contemplated; its absence would generate precisely the "grieving widow" headline that ended Swedish and Austrian estate taxation [10].
**Residual risk — strategic marriage.** An unlimited exemption makes marital status a tax instrument, and sham-marriage rules do not reach a *genuine* marriage entered partly for tax: the prohibited degrees (Marriage Act 1949, Sch. 1) bar marrying one's own child or grandchild, but not an unrelated chosen successor [18] — and over two hops (dynast marries younger spouse; surviving spouse later marries the dynast's grandchild, who is unrelated to *them*) capital could in principle chain down a generation untaxed. Three frictions keep this a corner case rather than a highway: each hop transfers full, unencumbered beneficial ownership (any binding side-arrangement to pass the wealth on is a settlement in substance, caught by the trust look-through and GAAR rules in [avoidance.md](avoidance.md)); the surviving spouse can simply keep the money, and faces divorce-law claims meanwhile; and the chain runs on decades-long marriage-and-mortality timing that cannot be compressed. It is nonetheless a real hole at the very top, and the honest fallback should be on the record: if chaining is observed in practice, the exemption converts to a *deferral* — spouse-to-spouse transfers stay untaxed on every widow and widower, but onward transmission from a surviving spouse who acquired above-threshold exempt wealth is cumulated against the ultimate recipients' thresholds at second death. That variant preserves the grieving-widow answer while closing the chain, at the cost of estate-tracking complexity.

...
- Spousal transfers are a legal exemption between partners ([carveouts.md](carveouts.md) §1) but an aggregate **deferral, not shrinkage**: wealth parked with a surviving spouse re-enters the taxable flow at the second death. Likewise the 30-year business/farm instalments smooth receipts without reducing them (and add interest at gilts + 1%).
...
| − Spousal transfers | **Timing shift only** — thins early-decade receipts by the average first-to-second-death gap; no reduction of the mature base | Between partners the transfer is fully exempt and consumes no threshold ([carveouts.md](carveouts.md) §1); the wealth is taxed when it leaves the marriage at second death. *Deferral of the generational base, not exemption from it* | [carveouts.md](carveouts.md) §1 |
...
| − Avoidance / flight residual | −5–12% of gross | Bounded, not assumed away: migration elasticities are lowest at exactly the binding life-stage (late age, settled family, illiquid assets); the high-elasticity populations are young, internationally famous, thinly attached [10] | [avoidance.md](avoidance.md); [`../08-capital-flight/evidence.md`](../08-capital-flight/evidence.md) |
...
3. **Mortality tables (ONS life tables)** — to time the flow: who dies when, and the first-to-second-death gap that sizes the spousal deferral.

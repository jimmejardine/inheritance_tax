# United Kingdom: The Strongest Single-Country Candidate

**Executive summary.** The UK combines everything the [adoption framework](adoption-criteria.md) says matters most: a unitary, majoritarian system with no codified constitutional bar, a functioning inheritance tax to reform rather than a dead one to resurrect, the developed world's most politically salient generational housing grievance, and a think-tank ecosystem that has already published adjacent proposals. Its obstacles — a hostile tabloid press, farmer symbolism, and a live non-dom exit narrative — are political rather than structural, which is exactly the kind of obstacle a well-designed campaign can address.

## Scorecard

| Criterion | Score /5 | Basis |
|---|---|---|
| C1 Administration | 5 | HMRC runs IHT, a mature gift regime (7-year rule), and the Land Registry; PAYE demonstrates mass pre-computed tax capacity |
...
The UK is the rare rich democracy where a government with a working majority can enact a structural tax reform in a single Finance Bill. There is no constitutional inheritance guarantee (contrast Germany, [continental-europe.md](continental-europe.md)), no referendum lock (contrast Switzerland, [unlikely-and-havens.md](unlikely-and-havens.md)), and no federal cascade risk (contrast Australia, [anglosphere.md](anglosphere.md)). The 1975 replacement of Estate Duty by Capital Transfer Tax, and CTT's 1986 replacement by IHT, show the machinery for wholesale transfer-tax redesign has been used twice within living memory. The legislative route is mapped in [`../15-transition/legislative-path-uk.md`](../15-transition/legislative-path-uk.md).

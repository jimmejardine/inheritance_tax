...
**Executive summary.** The modern optimal-taxation literature — the same formal apparatus used to argue *against* high capital-income taxes — generates strikingly high optimal inheritance-tax rates under plausible parameters: 50–60% in Piketty–Saez's baseline calibrations from the perspective of the majority of each cohort who inherit little or nothing, rising toward 70% with lower bequest elasticities or a historically realistic *r − g*, and above 80% when bequest motives are weak [1]. This file walks through the four main theoretical results, answers the one serious theoretical objection (Atkinson–Stiglitz), and translates every result into plain English — because a formal case that cannot be stated plainly is politically useless.
...
- Piketty–Saez (2013) derive the optimal inheritance-tax rate from three sufficient statistics — the elasticity of bequests, the aggregate importance of inheritance in lifetime resources, and the distribution of inheritances received. From the perspective of the ~half of each cohort who receive negligible inheritance — the paper's own "Meritocratic Rawlsian" criterion — calibrated optimal rates are 50–60% (59% US, 63% France at the benchmark bequest elasticity of 0.2), rising to ~70% with zero bequest elasticity or with *r − g* = 3%, and above 80% when bequest motives are weak [1].
...
The third statistic is the politically decisive one. Because inheritance is far more concentrated than labour income, the majority of each cohort receives little or nothing. For a social welfare function anchored on those zero-or-negligible-receivers — which is simply majoritarian democracy expressed as mathematics — the calibrated optimal rate is 50–60% in the baseline — the abstract's own phrase is "as large as 50%–60%—or even higher for top bequests" — rising to about 70% with zero bequest elasticity or with *r − g* at its historical 3%, and above 80% when bequest motives are weak (this welfare criterion, anchored on receivers of negligible bequests, is what the paper itself calls the "Meritocratic Rawlsian" optimum) [1]. The calibrations are blunt: the optimal linear rate is roughly stable at 50–60% across the entire bottom 70% of receivers in both France and the US, and even at an implausibly high bequest elasticity of 1 it remains about 35%.

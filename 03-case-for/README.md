...
- ~~Verification pass on the quantitative claims flagged "(to verify)"~~ — completed July 2026: the Piketty–Saez calibrated optima, the CTF/SEED OK/IDA effect sizes, and the land-reform, Homestead, and GI Bill magnitudes in [optimal-tax-theory.md](optimal-tax-theory.md), [equal-start.md](equal-start.md), [historical-precedents-of-success.md](historical-precedents-of-success.md), [wealth-tax-comparison.md](wealth-tax-comparison.md), and [democratic-renewal.md](democratic-renewal.md) are now checked against and cited to primary sources; figures were corrected where the sources differed (notably the GI Bill's modest causal share of the 1940–60 homeownership rise, the ten-year fade-out of the Tulsa IDA effect, and the valuation—not liquidity—grounds of the German 1995 wealth-tax ruling).

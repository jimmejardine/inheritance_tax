# Electoral Arithmetic: The Demographic Tailwind

**Executive summary.** The electoral case for the receipts tax and endowment does not depend on persuasion alone: the composition of the electorate is shifting mechanically toward non-inheritors, renters, and the priced-out young, while the estate-owning cohort is replaced by generational turnover. This file estimates where the crossover point lies — the moment at which a pro-inheritance-tax position becomes a net vote-winner — and identifies the "inheritance divide" within the young as the cleavage that will decide how the politics break.

## The mechanical shifts

Four slow-moving variables move the vote-maximising position, none of which any party controls:
...
None of these requires campaign success. They are the tide; campaigning determines only whether a party catches it early or late.
...
Define the crossover point as the election at which the expected vote gained from endowment beneficiaries and sympathisers exceeds the expected vote lost from threatened inheritors and estate-owners. Its location depends on five parameters:
...
| Constituency geography | Renter-heavy marginals | Rural/farm-heavy marginals ([../02-proposal/carveouts.md](../02-proposal/carveouts.md) exists for this) |

Three observations follow. First, the crossover is not a fixed date to be waited for; three of the five parameters are design and campaign choices. A well-designed, well-framed version may be past crossover *now* in renter-heavy urban electorates, while a badly framed version might never cross. Second, first-past-the-post geography matters more than national polling: the question is not "does this poll at 50%+1" but "does it win the marginal seats," which is why the farm and family-business carve-outs are electorally load-bearing rather than cosmetic. Third, turnout is the cheap margin: the endowment's natural beneficiaries are precisely the low-turnout young, so the same policy that persuades also mobilises — a double-counting effect that standard vote-share polling understates (developed in [left-parties.md](left-parties.md)).

# Precedents: Fringe-to-Mainstream Case Studies

**Executive summary.** Marriage equality, the $15 minimum wage, UBI, and carbon pricing each supply one transferable mechanism — personal-story persuasion, demand discipline, respectability cascades, and a warning about technocracy without a base — while Georgism and the 2020 wealth-tax moment show how movements with winning arguments still lose. The most instructive case of all is the opponent's: the US death-tax repeal coalition, which organised (not merely messaged) its way to repealing a tax on the richest 1–2% with majority public support.

## Success cases and what to copy
...
- **Jurisdictional laddering:** city and state wins created proof and momentum before federal politics moved — cf. [15-transition/pilots.md](../15-transition/pilots.md) and [11-geographies/adoption-criteria.md](../11-geographies/adoption-criteria.md).

### UBI's respectability cascade

Covered as a theory-of-change template in [theory-of-change.md](theory-of-change.md). The specific copyable sequence: pilots generate evidence → evidence generates respectable coverage → high-status validators (tech founders, mainstream economists) make advocacy safe for mid-status people → a political entrepreneur carries it into electoral politics. The cascade is a *status* mechanism: each stage lowers the reputational price of the next advocate's endorsement. Copy: run the cascade deliberately, recruiting validators in descending order of independence ([messengers.md](messengers.md)). Avoid: UBI reached familiarity without a costed bill or a beneficiary organisation — awareness without infrastructure.
...
- **Founder-identification.** The movement never outgrew Henry George; when his moment passed, so did its. See founder-capture governance in [organisational-forms.md](organisational-forms.md).
...
## The "what kills movements like ours" checklist

Standing diagnostics, reviewed annually against our own state:

| Killer | Mechanism | Our guard |
|---|---|---|
| Purism | Full-doctrine membership tests repel allies; sect replaces movement | Minimum shared demand for coalition; 100% held as manifesto position ([coalitions.md](coalitions.md)) |
| No concrete demand | Vague causes cannot score wins or discipline messaging | The numbers: £500k / £50k / 25 ([02-proposal/](../02-proposal/README.md)) |
| No beneficiary constituency | Nobody defends the policy under attack; carbon-pricing fate | Endowment recipients organised into rings 3–4 ([recruitment.md](recruitment.md)) |
| Single-charismatic-founder risk | Movement inherits founder's liabilities and lifespan; Georgist fate | Succession, rotation of messengers, open corpus ([organisational-forms.md](organisational-forms.md), [messengers.md](messengers.md)) |
| Candidacy-dependence | Policy dies with the campaign that carried it; Warren fate | Independent institution precedes party adoption ([theory-of-change.md](theory-of-change.md)) |
| Attention without capture | Viral moments leave no members | Every output ends in a subscription step ([recruitment.md](recruitment.md), ring 4) |
| Funder monoculture | Agenda bends to one chequebook, or dies with it | Diversity caps, irrevocable gifts, membership base ([funding.md](funding.md)) |

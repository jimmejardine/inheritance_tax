...
**Executive summary.** The dean of inequality measurement closed his career with fifteen concrete proposals, two of which — a progressive lifetime capital receipts tax and a universal minimum inheritance at adulthood — constitute, in embryo, the exact architecture this project specifies. Atkinson supplies the proposal's technical framing ("capital receipts," not "death duties") and its deepest authority anchor: the case comes from the scholar who built the field's data.
...
1. **Recipient basis.** The taxable event is *receiving*, not dying — the Millian move ([mill-1848.md](mill-1848.md)) finally given full fiscal engineering.
2. **Lifetime cumulation.** Every gift and inheritance adds to one running personal total; rates apply to the total, so splitting transfers across years or donors achieves nothing. Ireland's Capital Acquisitions Tax, which Atkinson cites as the working precedent, already operates a group-threshold version of this ledger [1][3].
3. **Gift integration.** *Inter vivos* gifts are inside the base by construction — the leak that destroyed UK Estate Duty ([uk-estate-duty.md](uk-estate-duty.md)) is sealed at the level of definition, not by survivorship rules.

And the book's signature symmetry: the receipts tax *funds* the minimum inheritance. Atkinson states the pairing plainly — taxing the inheritances of the few to endow an inheritance for all — completing the circuit Paine opened in 1797 [1].
...
| 3 | Unemployment target and guaranteed public employment at the minimum wage |
| 4 | National pay policy: statutory minimum wage as a living wage; pay codes |
| 5 | National savings bonds with a guaranteed positive real return, capped per person |
| **6** | **Capital endowment (minimum inheritance) paid to all at adulthood** |
| 7 | Public investment authority — a sovereign wealth fund building the state's net worth |
| 8 | Return to a more progressive income-tax schedule, top rate ~65% |
| 9 | Earned-income discount in the income tax, favouring labour over capital income |
...
- **The name and the frame.** "Lifetime capital receipts tax" is the technically correct, politically superior description of what this project proposes — no death, no estate, no duty. Adopted throughout [../14-communications/naming-and-language.md](../14-communications/naming-and-language.md).
- **Establishment pedigree.** Meade (1978) → Mirrlees (2011) → Atkinson (2015) → OECD (2021) is an unbroken chain of mainstream expert endorsement for the *structure* (if not the 100% rate); this is the answer to "fringe idea" attacks ([../09-objections/practicality.md](../09-objections/practicality.md), [../10-opposition/attack-playbook.md](../10-opposition/attack-playbook.md)).
- **The authority anchor.** The proposal's empirical premises come from the man who built the measurements — a provenance argument developed in [../13-movement/messengers.md](../13-movement/messengers.md).
- **The feasibility temperament.** Atkinson's method — meet every "it can't be done" with worked institutional detail — is the house style this project's [../07-implementation/](../07-implementation/README.md) section inherits.

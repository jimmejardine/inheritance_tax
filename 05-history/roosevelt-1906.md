# Theodore Roosevelt: The 1906 Message and the New Nationalism (1910)

**Executive summary.** A Republican president made the inheritance tax a mainstream American demand, arguing from explicitly conservative premises: that swollen hereditary fortunes are an aristocratic institution incompatible with a republic of equal opportunity. Roosevelt's speeches are the bridge between Carnegie's private gospel and the 1916 statute — and the clearest proof that this cause has a native home on the political right.

## Context: the Republic and the trusts

Roosevelt spoke at the crest of the Gilded Age settlement: Standard Oil, the railroad trusts, and the first generation of nine-figure fortunes passing to heirs, against a backdrop of muckraking journalism and agrarian and progressive revolt [1]. His response was not socialist — he prosecuted "bad trusts" while defending big enterprise as such — but *republican* in the small-r sense: concentrated hereditary wealth was a threat to self-government of the same species as titled aristocracy, which the founders had banned outright (the Constitution's titles-of-nobility clauses being, on this reading, America's first anti-dynasty law).
...
Roosevelt's case rests on premises modern conservatives affirm:

- **Anti-aristocracy.** The republic's founding commitment is careers open to talent, not hereditary station. A permanent inheritor class is un-American on originalist grounds.
- **Equality of opportunity, not outcome.** Roosevelt attacked the *starting-line* distortion only; he celebrated fortune-building itself.
- **The character argument.** Like Carnegie ([carnegie-1889.md](carnegie-1889.md)), he held that unearned wealth corrodes the virtues — industry, self-reliance — that conservatives claim to defend.
- **National cohesion.** Swollen fortunes were, for TR, a solvent of the common citizenship that patriotic conservatism prizes.

This makes Roosevelt the anchor citation for the right-of-centre adoption path mapped in [../12-political-adoption/right-parties.md](../12-political-adoption/right-parties.md) and the framing work in [../06-palatability/framing.md](../06-palatability/framing.md): the proposal can be presented, with full historical warrant, as the completion of a Republican president's programme rather than an import from the left.

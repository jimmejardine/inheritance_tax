...
**Executive summary.** *Agrarian Justice* is the founding document of the tax-plus-endowment pairing: a levy on estates at death funding a universal capital grant at adulthood and a pension in old age, justified not as charity but as compensation for a common inheritance (the earth) that private property law had enclosed. Written amid the French Revolution and suppressed by two centuries of neglect, it is the direct ancestor of the design specified in [../02-proposal/endowment.md](../02-proposal/endowment.md).
...
Paine's justification is not egalitarian levelling but restitution. The chain of reasoning:

1. **The earth in its natural, uncultivated state was, and ever would have been, the common property of the human race** (near-verbatim from the text; quote to verify) [1].
2. Cultivation is legitimate and beneficial — Paine explicitly defends the *improvement* value created by owners — but it is impossible to improve land without also enclosing the underlying natural value that belonged to everyone.
3. Every landowner therefore "owes to the community a ground-rent" for the land he holds (quote to verify) [1].
4. Because tracing the natural value parcel-by-parcel is impossible, the practical moment to collect the ground-rent is **the transmission of property at death**, when ownership is in any case being reassigned by law, not by the owner's continuing effort.
5. The proceeds are owed to every person, as *indemnification for the loss of his or her natural inheritance* — hence a universal payment, "to preserve the benefits of what is called civilized life, and to remedy at the same time the evil which it has produced" (quote to verify) [1].

This is the crucial move the present project inherits: inheritance taxation framed as the *restoration of an inheritance to everyone*, not the confiscation of anyone's. See [../06-palatability/framing.md](../06-palatability/framing.md) and [../14-communications/narratives.md](../14-communications/narratives.md).

## The mechanics

| Element | Paine's specification (figures to verify against the 1797 text) |
|---|---|
| Levy | ~10% on the value of property passing at death to direct heirs, with a supplementary schedule (roughly a further tenth) on bequests beyond the direct line |
| Fund | A "National Fund" — hypothecated, not general revenue |
| Universal grant | £15 sterling to every person on reaching age 21, "as a compensation in part, for the loss of his or her natural inheritance, by the introduction of the system of landed property" (quote to verify) |
| Pension | £10 per year to every person aged 50 and over, for life |
| Disability | Equivalent payments to the blind and lame unable to work, at any age |
| Universality | Explicitly paid to rich and poor alike, "to prevent invidious distinctions" (quote to verify) |

Two design features deserve emphasis. First, Paine ran the numbers: the pamphlet contains actuarial tables estimating national capital, annual deaths, and the fund's arithmetic from English population data — it is a costed policy, not a utopia [1]. Second, universality was a deliberate anti-stigma and anti-erosion device, anticipating by two centuries the political-economy argument in [abolitions.md](abolitions.md) that means-tested or invisible benefits leave transfer taxes politically undefended.
...
- **The origin of the pairing.** Paine is the primary-source anchor for the claim in [00-executive-summary.md](../00-executive-summary.md) that every serious proposal couples the tax with a universal benefit. The endowment design in [../02-proposal/endowment.md](../02-proposal/endowment.md) is Paine's £15-at-21, indexed and enlarged.
- **A non-socialist justification.** Paine defends property and improvement; the levy is a *rent owed*, not an expropriation. This gives the proposal a lineage acceptable to liberals and conservatives — usable alongside [carnegie-1889.md](carnegie-1889.md) and [roosevelt-1906.md](roosevelt-1906.md) in [../12-political-adoption/right-parties.md](../12-political-adoption/right-parties.md).

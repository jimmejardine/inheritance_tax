...
| [has-this-been-proposed.md](has-this-been-proposed.md) | The novelty audit: Haslett's 100%-above-a-lifetime-quota (1997), Robeyns' identical 2024 "accessions cap" with citizen's stake, Rignano, Dalton, Huey Long, Ascher, the Soviet 1918 decree, Ecuador 2015 — the full component matrix, and what genuinely remains new here |
...
- **Andrew Carnegie, "The Gospel of Wealth" (1889).** The era's richest industrialist argued heavy graduated death duties were morally required and good for the heirs themselves: "By taxing estates heavily at death the State marks its condemnation of the selfish millionaire's unworthy life" ([primary text](https://archive.swarthmore.edu/www1/SocSci/rbannis1/AIH19th/Carnegie.html)). See [carnegie-1889.md](carnegie-1889.md).
- **Theodore Roosevelt (1906 State of the Union; 1910 New Nationalism speech).** A Republican president's demand for "a graduated inheritance tax on big fortunes, properly safeguarded against evasion" (New Nationalism speech, 1910 — [primary text](https://en.wikisource.org/wiki/The_New_Nationalism)), on anti-aristocratic republican grounds. See [roosevelt-1906.md](roosevelt-1906.md).

### Twentieth century: high-water marks

- **US Federal Estate Tax (1916– ).** Top marginal rate reached 77% in 1941 and held there until 1976; today's $15m exemption (from 2026, made permanent by the July 2025 tax act) leaves the tax touching roughly 0.1% of deaths. What the plateau proves (survivability) and doesn't (effective collection) is set out in [us-estate-tax.md](us-estate-tax.md).
...
- **The philosophers of the exact mechanism.** D.W. Haslett argued for abolishing large inheritance in 1986 and by 1997 for a per-recipient lifetime quota with 100% taxation above it; Ingrid Robeyns' 2024 "accessions cap" pairs that same 0/100 lifetime design with a universal citizen's stake — the closest published relatives of this proposal's mechanism. France's CAE Note 69 (2021, Landais & Stantcheva among the authors) is the nearest official-advisory cousin: lifetime-receipts taxation funding a capital guarantee of up to €40,000 at 18. See [has-this-been-proposed.md](has-this-been-proposed.md).
...
Every serious historical proposal pairs a tax on large transfers with a universal benefit to small inheritors — Paine's grant, Long's household estate, Ackerman–Alstott's stake, Atkinson's minimum inheritance, Piketty's endowment, the CAE's capital guarantee, Robeyns' citizen's stake. Pure confiscation without the redistribution half has no serious intellectual proponent in the record — a useful debating point against strawman attacks ([../14-communications/debate-toolkit.md](../14-communications/debate-toolkit.md)). Conversely, every *statutory* regime that lacked a visible individual beneficiary eventually eroded or died ([abolitions.md](abolitions.md)). History's instruction is symmetrical: the tax defends the endowment's funding; the endowment defends the tax's politics.

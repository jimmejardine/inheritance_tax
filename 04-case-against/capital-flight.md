# The Capital Flight Objection

**Executive summary.** The objection: wealth and its owners are mobile, the tax targets precisely the most mobile cohort, and a unilateral adopter will watch its fortunes — and their taxes, jobs, and philanthropy — leave, as the Nordic treasuries concluded from their own experience. This file states that case at full strength, including its two deepest forms — the structural power of exit *threats*, and the geopolitical claim that a first mover forfeits its national-champion class even if the tax is revenue-positive — assesses what the migration-elasticity evidence actually supports, and concedes the honest residual before handing the full design treatment to [`../08-capital-flight/`](../08-capital-flight/README.md).
...
Even if coordinated adoption would work, no coordination exists. The first mover pays the full price — departed fortunes, lost venture capital, a reputational "closed for wealth" sign — while its neighbours collect the refugees. Switzerland, Italy (with its flat-tax regime for wealthy immigrants), the UAE, and Singapore actively market themselves to exactly this flow. Game-theoretically, the objection says, this is a prisoner's dilemma the proposal simply refuses to see ([`../08-capital-flight/game-theory.md`](../08-capital-flight/game-theory.md) takes this up).

### 4. The deep version: exit threats discipline policy before it happens

The most sophisticated form of the objection is structural, and it comes from the left as much as the right. Lindblom's "market as prison" argument (*Politics and Markets*, 1977) and the Przeworski–Wallerstein formalisation of the structural dependence of the state on capital [2][3] hold that governments in capitalist democracies are disciplined not by actual capital flight but by its *anticipation*: investment is a private decision, so any policy that lowers expected returns to wealth-holders is punished automatically — by slowed investment, currency pressure, and rising borrowing costs — before a single millionaire packs a suitcase. On this view the debate about migration elasticities misses the point. The tax could be perfectly enforceable at death and still be defeated in life, through the investment channel, the moment it becomes a credible legislative prospect. This is the strongest single argument in this file, because it does not depend on any empirical claim about who actually moves ([`../15-transition/announcement-effects.md`](../15-transition/announcement-effects.md) addresses the transition-period version of it).

### 5. The geopolitical version: the first mover forfeits its national-champion class

Distinct from every fiscal argument above — and surviving even if the tax is revenue-positive on Moretti–Wilson logic — is a claim about national *power*. Sovereign-adjacent capability increasingly lives inside private fortunes: launch capacity, satellite communications, frontier AI, defence-adjacent deep tech are founded, controlled, and patient-financed by exactly the ultra-wealthy cohort this tax targets. The emblematic case is documented, not hypothetical: in Ukraine, a privately owned satellite constellation became core battlefield infrastructure, and its owner personally decided where it did and did not function — including declining to enable coverage for a Ukrainian strike on the Russian fleet at Sevastopol [12]. Whatever one thinks of that arrangement, it demonstrates that states now *rent* strategic capability from billionaires. A country that announces the extinction of dynastic fortunes, the objection runs, tells its future founders of such enterprises to build them elsewhere — and simultaneously forfeits the anchor investors for national champions, the sovereign-scale philanthropy, and the soft power that follow the flag of private money. Rival states court precisely this cohort. On this view the fiscal ledger of [`../08-capital-flight/`](../08-capital-flight/README.md) misses the real account: a first mover may collect the revenue and still lose the strategic industries, permanently, to allies and adversaries who did not move.
...
4. **The geopolitical version conflates the fortune with the capability.** Three distinctions cut it down without dissolving it. (i) *Strategic firms are jurisdiction-bound in ways their owners are not*: incorporation, export-control and national-security-review regimes, security clearances, and situs rules attach to the company and its assets regardless of where the owner — or the owner's estate — is taxed; a transfer tax reallocates *claims on* the firm, not the firm. (ii) *The tax binds heirs at death, not founders in life*: national champions are a founder phenomenon, built by people whose control, compensation, and holdings this tax never touches while they live; what transmits at death is a shareholding, and the succession literature finds birthright control *degrades* firm capability rather than preserving it ([`family-business.md`](family-business.md)). (iii) *In-specie settlement keeps strategic stakes domestic*: above-threshold holdings in sensitive enterprises pass to the state fund rather than to a foreign acquirer — if anything an increase in sovereign control, purchased at the Hayekian cost already priced in [`state-failure.md`](state-failure.md). What the distinctions do not answer is the *location decision of the not-yet-founded firm*: a young future founder choosing where to build weighs the whole fiscal-cultural package, and that channel is real, unmeasurable in advance, and belongs in the priced-in column beside the Lindblom threat.
...
- a rival-jurisdiction dynamic in which post-adoption departures visibly cluster among *founders of operating businesses* rather than holders of liquid portfolios — the loss category the tolerable-loss framing below cannot absorb; the geopolitical version (§5) sharpens if such clustering appears specifically in defence-adjacent and frontier-technology sectors, or in where new strategic firms choose to *incorporate* rather than merely where their founders sleep.
...
12. [Washington Post, "Whatever the fuss over Elon Musk, Starlink is utterly essential in Ukraine" (8 September 2023)](https://www.washingtonpost.com/world/2023/09/08/elon-musk-starlink-ukraine-war/); [Washington Post, "Musk secretly told SpaceX to turn off Starlink during Ukraine offensive" (7 September 2023)](https://www.washingtonpost.com/technology/2023/09/07/ukraine-starlink-musk-biography/).

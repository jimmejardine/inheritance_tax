...
**Executive summary.** The objection: wealth and its owners are mobile, the tax targets precisely the most mobile cohort, and a unilateral adopter will watch its fortunes — and their taxes, jobs, and philanthropy — leave, as the Nordic treasuries concluded from their own experience. This file states that case at full strength, including its deepest form (the structural power of exit *threats*), assesses what the migration-elasticity evidence actually supports, and concedes the honest residual before handing the full design treatment to [`../08-capital-flight/`](../08-capital-flight/README.md).

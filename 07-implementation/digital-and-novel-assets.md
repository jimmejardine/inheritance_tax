...
NFTs and tokenised real-world assets follow their substance: an NFT is a crypto-asset priced by market evidence where a liquid market exists and by the art/collectibles route ([valuation.md](valuation.md) §4) where it does not; a token that is legally a claim on land, equity, or a fund is valued as the underlying claim, with the token layer treated as mere form — the general anti-relabelling principle of §6 applied in miniature.

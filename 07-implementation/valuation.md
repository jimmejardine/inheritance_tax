...
At a 40% rate, shaving 25% off a declared value saves the taxpayer 10p in the pound; at a 100% marginal rate it saves 25p. The incentive to undervalue scales with the rate, so the regime defined in [`../02-proposal/mechanism.md`](../02-proposal/mechanism.md) §4 needs valuation machinery stronger than anything the UK or US currently operates.

One baseline fact frames everything below: **this regime does not create the valuation event — it raises the stakes of one the law already compels.** Every UK estate must already be valued for probate, whether or not any tax is due [8]; every US inherited asset is already valued at death regardless of estate-tax liability, because the heir's capital-gains basis steps up to date-of-death value under IRC §1014 [9]; and the same assets are valued between deaths for divorce, insurance, and lending. The task is therefore hardening an existing once-per-generation valuation against a 100% marginal incentive — not building the annual revaluation apparatus whose cost helped kill the OECD's net wealth taxes ([`../03-case-for/wealth-tax-comparison.md`](../03-case-for/wealth-tax-comparison.md) §2). The historical warnings are specific: Austria's inheritance tax was struck down in 2007 largely because frozen cadastral values (*Einheitswerte*) made the effective rate arbitrary between asset classes [1], and US Tax Court dockets show decades of minority-discount stacking in family entities (see §5). The design principle throughout: **the taxpayer proposes, the state can verify, and the consequences of being caught proposing badly are severe and public.**
...
8. [GOV.UK — "Valuing the estate of someone who's died": estate valuation required for probate whether or not Inheritance Tax is due](https://www.gov.uk/valuing-estate-of-someone-who-died)
9. [26 U.S. Code §1014 — stepped-up basis: every inherited asset is valued at date of death irrespective of estate-tax liability](https://www.law.cornell.edu/uscode/text/26/1014)
